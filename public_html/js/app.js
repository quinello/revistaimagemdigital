...
//                    deps: ['uiLoad',
//                      function( uiLoad ){
//                        return uiLoad.load( ['js/masonry/imagesloaded.pkgd.js',
//                                             'js/masonry/masonry.pkgd.js',                                             
//                                             'js/masonry/load_images.js']);
//                                         
//                    }]
//                }
                                })
                                ...
                                .state('app.inicio', {
                                    url: '/inicio',
                                    templateUrl: 'tpl/app_inicio.html'
//                                    resolve: {
//                                        deps: ['uiLoad',
//                                            function(uiLoad) {
//                                                return uiLoad.load(['js/masonry_q/jquery-1.7.1.min.js',
//                                                    'js/masonry_q/jquery.masonry.min.js',
